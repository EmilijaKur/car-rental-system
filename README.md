...
This is a simple car rental management system. The program allows users to view, rent, and return vehicles. Python file operations, exception handling, and modular programming were used.
...
| Reg Nr   | Model                                   | Price per Day | Properties                             |
|----------|-----------------------------------------|---------------|----------------------------------------|
